...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private void simulateTwitterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) {
        // Ejecuta esta tarea en otro hilo. De esta forma, no bloquea el hilo principal
        // Implementamos, mediante una función lambda, la "Functional Interface" "Runnable" que recibe el método "submit"
